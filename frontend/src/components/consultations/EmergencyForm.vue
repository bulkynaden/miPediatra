    ...
    <div class="grid sm:grid-cols-1 md:grid-cols-2 gap-4 pt-4">
      <div class="md:col-span-1">
        ...
        <div class="flex-grow ml-2">
          <SymptomsComo @selected-item="handleSelectedSymptom" />
...
import SymptomsComo from "@/components/consultations/SymptomsCombo.vue";

export default {
  name: "EmergencyForm",
  components: { SymptomsComo, "ejs-textbox": TextBoxComponent },
  props: ["formData"],
  data() {
    return {
      isValidSymptom: true,
